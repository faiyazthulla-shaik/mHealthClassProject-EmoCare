package com.pacman.EmoCare.ui.emergency;
...
public class EmergencyDialogFragment extends DialogFragment {
    ...
    public void text(String phone) {
        ...
        if (ContextCompat.checkSelfPermission(getActivity(),Manifest.permission.SEND_SMS) != PackageManager.PERMISSION_GRANTED){
            ...
            sendMessage.putExtra("sms_body","I am currently experiencing an emergency and have notified emergency services. This message was sent by the EmoCare app");
